...
function twentythirteen_scripts_styles() {
	...
	// Loads Modernizr.js
	wp_enqueue_script( 'jquery-modernizr', get_template_directory_uri() . '/js/modernizr.js', array( 'jquery' ), '2013-07-18', true );

	// Add Foundation.css.
	wp_enqueue_style( 'foundation', get_template_directory_uri() . '/css/foundation.css', array(), '2.09' );

	// Loads our main stylesheet.
	wp_enqueue_style( 'manufactura-style', get_stylesheet_uri(), array(), '2013-07-18' );
